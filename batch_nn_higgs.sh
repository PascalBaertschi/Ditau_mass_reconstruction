...
OUTFILE16=${INPUT}_125GeV.png
OUTFILE17=${INPUT}_125GeV_rescompar.png
OUTFILE18=${INPUT}_180GeV.png
OUTFILE19=${INPUT}_180GeV_rescompar.png
OUTFILE20=${INPUT}_250GeV.png
OUTFILE21=${INPUT}_250GeV_rescompar.png
OUTFILE22=${INPUT}_gen.png
OUTFILE23=${INPUT}_svfit_corr.png
OUTFILE24=${INPUT}_svfit_corrres.png
...
mkdir -p $WORKDIR
cd $WORKDIR
python $BASEDIR/nn_higgs.py $INPUT
...
cp $WORKDIR/$OUTFILE23 $OUTDIR/$OUTFILE23
cp $WORKDIR/$OUTFILE24 $OUTDIR/$OUTFILE24
