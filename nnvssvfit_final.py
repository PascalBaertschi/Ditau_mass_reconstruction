...
list_name = "/mnt/t3nfs01/data01/shome/pbaertsc/tauinitial/CMSSW_8_0_25/src/XtautauML/reg_ditau_mass_NNvsSVfitMET_withtaunu4Vec_2e4.csv"
...
#dataframe_ditaumass = pandas.read_csv("/mnt/t3nfs01/data01/shome/pbaertsc/tauinitial/CMSSW_8_0_25/src/XtautauML/reg_ditau_mass_NNvsSVfitMET_8e5_all.csv",delim_whitespace=False,header=None)
...
histditaumass = ROOT.TH1D("ditaumass",histtitle,100,0,200)
...
histditauvismass = ROOT.TH1D("ditauvismass","ditauvismass",100,0,200)
...
output_name = "ditau_mass_svfit_%s_decays_test33" % (decaymode)
#output_name = "ditau_mass_svfit_decaymodes"
...
for j in range(len(ditaumass_svfit_calc)):
    ...
    #print "actual mass:",ditaumass_actual_loop,"reconstructed mass:",ditaumass_svfit_calc_loop
