...
OUTFILE1=${INPUT}.txt
OUTFILE2=${INPUT}.png
OUTFILE3=${INPUT}_delta.png
OUTFILE4=${INPUT}_res.png
OUTFILE5=${INPUT}.root
OUTFILE6=${INPUT}_corr.png
OUTFILE7=${INPUT}_corrres.png
OUTFILE8=${INPUT}_profres.png
OUTFILE9=${INPUT}_profabsres.png
...
mkdir -p $WORKDIR
cd $WORKDIR
python $BASEDIR/svfit_cuts.py $INPUT
